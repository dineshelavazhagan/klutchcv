...
class ball_det():
    ...
    def create_new_video(self,frame_size,zoom_factor,file_name):
        full_path = os.path.join("../data/proccessed/FEBRUARY_26.23-20230301T152455Z-001/",file_name)
...
# def main(file_name, source, frame_size):
    ...
    with torch.no_grad():
        ...
        # source = "../data/raw/mergedVideo_1677429059.989999.mp4"
        ball_dets = ball_det()
        # file_name = 'mergedVideo_1677429059.989999.mp4' # inject name
